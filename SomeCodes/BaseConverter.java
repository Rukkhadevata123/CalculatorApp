...
public class BaseConverter extends JFrame {
    ...
    private final JComboBox<String> sourceBox; // To select the source base
    private final JComboBox<String> targetBox; // To select the target base
    private final JTextField inputField; // To input the number
    private final JTextField outputField; // To output the number
    private final JLabel resultLabel; // To show the conversion result or error message

    // Constructor
    public BaseConverter() {
        // Initialize the components
        // To store the supported bases
        String[] bases = new String[]{"2", "3", "4", "5", "6", "7", "8", "9", "10", "16"}; // The supported bases
        ...
        JButton convertButton = new JButton("Convert"); // Create a button for conversion
        ...
        convertButton.addActionListener(e -> {
            ...
            int sourceBase = Integer.parseInt((String) Objects.requireNonNull(sourceBox.getSelectedItem()));
            int targetBase = Integer.parseInt((String) Objects.requireNonNull(targetBox.getSelectedItem()));
